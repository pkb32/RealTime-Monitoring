...
const ExtensoMeter = () => {
  ...
  const dataSets = {
    "L11 North 13 X-cut": {
      ...
      datasets: [
        {
          label: "Cumulative Difference (Anchor Depth: 12 mtr)",
        ...
        {
          label: "Cumulative Difference (Anchor Depth: 9 mtr)",
        ...
        {
          label: "Cumulative Difference (Anchor Depth: 6 mtr)",
        ...
        {
          label: "Cumulative Difference (Anchor Depth: 3 mtr)",
  ...
  return (
    <div className="w-full text-white bg-gray-500">
      ...
      <div className="flex gap-4 m-5">
        <div className="flex-auto h-[815px] bg-gray-400 p-4"> 
          <Line
            data={{
        ...
        <div className="flex flex-col gap-4">
          <div className="h-[400px] w-[200px] bg-red-500 rounded-md p-4"> 
          ...
          <div className="h-[400px] w-[200px] p-4 bg-green-700 rounded-md"> 
            <h1 className="font-bold mb-2">Observation</h1>
